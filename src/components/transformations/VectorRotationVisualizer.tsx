...
const VectorRotationVisualizer: React.FC = () => {
  ...
  const rotateVector = (v: VectorProps, angle: number): VectorProps => {
  ...
  const rotatedVector = rotateVector(vector, rotationAngle);
...
export default VectorRotationVisualizer; 